...
-------------------------------------------------------------------------------------------------*/
/*
DROP database IF EXISTS jrelais;
create database jrelais;
GRANT SELECT , 
	INSERT , 
	UPDATE , 
	DELETE , 
	...
	ON jrelais.* TO 
	'jrelaisuser'@'192.168.0.%' IDENTIFIED BY '78gtFgufczfz';
...
-- DROP INDEX  userrole ON userroles;
